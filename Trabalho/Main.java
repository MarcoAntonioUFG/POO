...
public class Main {
    public static void main(String[] args) {
        ...
        String caminhoArquivoProdutos = "C:\\projetos\\aulas\\aula6_sistemaPedidos\\produtos.txt";
        String caminhoArquivoCliente = "C:\\projetos\\aulas\\aula6_sistemaPedidos\\cliente.txt";
        List<Produto> produtos = ProdutoFileReader.lerArquivo(caminhoArquivoProdutos);
        List<Cliente> clientes = ClienteFileReader.lerArquivo(caminhoArquivoCliente);
